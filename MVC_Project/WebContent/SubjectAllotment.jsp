...
<!-- 					<ul class="nav navbar-nav navbar-right">
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1>Subject Allotment<span class="m_1">Lorem Ipsum dolroin gravida nibh vel velit.</span></h1>
		</div>
	</div>
			...
			<div class="row">
                    ...
                    <div class="pricingTable pink">
                        ...
                        <div class="pricingContent">
                            <br>
                            <form action="SubmitSubjectAllotment.jsp">
                            <center><table cellspacing=0 cellpadding=12 border=0 width=100% layout=fixed>
                            
<tr><td>Select Faculty</td><td><select name="fid"><option>-Select Faculty-</option>
<%
	try
	{
	ResultSet rs=DAO.displayRecord("select *from faculty_reg");
	while(rs.next()){
...
<tr><td>Select Subject</td><td><select name="subid"><option>-Select Subject-</option>
<%
	try
	{
	ResultSet rs=DAO.displayRecord("select *from add_subject");
	while(rs.next()){
		out.println("<option value="+rs.getString(2)+">"+rs.getString(3)+"</option>");
	}
}catch(Exception exp){
...
%>
<tr><td>Allotment Date: </td><td><input type="text" name=sadate value=<%=TodaysDate %> readonly></td></tr>
<tr><td><input type="submit" value="Allot"></td><td><input type="reset" value="Reset"></td></tr>
                            </table>
                            </center>
                            </form>
