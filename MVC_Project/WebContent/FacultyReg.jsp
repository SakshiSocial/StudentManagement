...
<!-- 					<ul class="nav navbar-nav navbar-right">
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1>Faculty Registration<span class="m_1">Lorem Ipsum dolroin gravida nibh vel velit.</span></h1>
		</div>
	</div>
			...
			<div class="row">
                    ...
                    <div class="pricingTable pink">
                        ...
                        <div class="pricingContent">
                            <br>
                            <form action="SubmitFacultyReg.jsp">
...
<tr><th>Course: </th><td>
<select name="cid"><option>-Select Course-</option>
<%
try
{
...
<tr><th>E-mail: </th><td><input type="email" name="femail"></td></tr>
