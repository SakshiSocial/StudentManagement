...
<!-- 					<ul class="nav navbar-nav navbar-right">
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1>Branch Registration<span class="m_1">Lorem Ipsum dolroin gravida nibh vel velit.</span></h1>
		</div>
	</div>
			...
			<div class="col-md-4 col-sm-6">
                    <div class="pricingTable pink">
                        <div class="pricingTable-header">
                            ...
                            <span class="price-value"> <span>add branch here</span></span>
                        </div>

                        <div class="pricingContent">
                            <br>
                            <form action="SubmitBranchReg.jsp">
                            <center><table cellspacing=0 cellpadding=12 border=0 width=100% layout=fixed>
                            

                            <tr><th>Course ID: </th><td><select name="cid"><option>-Select Course-</option>
...
<tr><th>Branch Name: </th><td><input type="text" name="bname" placeholder="Enter Branch"></td></tr>
<tr><th>Branch icon: </th><td><input type="file" name="bicon"></td></tr>
<tr><th>Description: </th><td><textarea rows="3" cols="25" name="bdesc"></textarea></td></tr>
<tr><td><input type="submit" value="Submit"></td><td><input type="reset" value="Reset"></td></tr>
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;
                    <div class="pricingTable pink">
                        <div class="pricingTable-header">
                            ...
                            <span class="price-value"> <span>Edit/Delete branch here</span></span>
                        </div>
	...
	ResultSet rs1=DAO.displayRecord("select * from branch_reg");
	if(rs1.next()) {
		
		out.println("<tr><th>Branch ID</th><th>Branch Name</th><th>Branch Description</th><th>Update/Delete</th><th>Add Subjects</th></tr>");
		do {
			out.println("<tr><td>"+rs1.getString(2)+"</td><td>"+rs1.getString(3)+"</td><td>"+rs1.getString(5)+"</td><td><a href=BranchUpdate.jsp?bid="+rs1.getString(2)+">Update/Delete</a></td><td><a href=AddSubjects.jsp?bidd="+rs1.getString(2)+">Add_Subject</a></td></tr>");
		}while(rs1.next());
