...
<!-- 					<ul class="nav navbar-nav navbar-right">
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1>Search Students<span class="m_1">Lorem Ipsum dolroin gravida nibh vel velit.</span></h1>
		</div>
	</div>
			...
			<div class="row">
                    ...
                    <div class="pricingTable pink">
                        <div class="pricingTable-header">
                            ...
                            <span class="price-value"> <span>Details of Student</span></span>
                        </div>
                        ...
                        <div class="pricingContent">
                            ...
                            <%
                            	...
                            	if(cid.equals("0") && bid.equals("0")){
                            		String q="select * from student_reg";
                            		ResultSet rs=DAO.displayRecord(q);
                            		out.println("<center>");
                            		out.println("<table cellspacing=0 cellpadding=12 border=0 width=100% layout=fixed>");
                            		out.println("<tr><th>ID</th><th>Name</th><th>DOB</th><th>City</th><th>Mobile</th><th>Email</th></tr>");
                            		if(rs.next()){
                            			do{
                            				out.println("<tr><td>"+rs.getString(1)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(3)+"</td><td>"+rs.getString(5)+"</td><td>"+rs.getString(8)+"</td><td>"+rs.getString(9)+"</td></tr>");
                            			}while(rs.next());
                            		}
                            		out.println("</table>");
                            		out.println("</center>");
                            			...
                            			String q1="select * from student_reg where Branch_id="+bid+"";
                            			ResultSet rs=DAO.displayRecord(q1);
                            			out.println("<center>");
                            			out.println("<table cellspacing=0 cellpadding=12 border=0 width=100% layout=fixed>");
                            			out.println("<tr><th>ID</th><th>Name</th><th>DOB</th><th>City</th><th>Mobile</th><th>Email</th></tr>");
                            			if(rs.next()){
                            		...
                            		out.println("</center>");
                            			...
                            			String q2="select * from student_reg sr, branch_reg br where br.course_id="+cid+" and br.branch_id=sr.Branch_id";
                            			ResultSet rs=DAO.displayRecord(q2);
                            			out.println("<center>");
                            			out.println("<table cellspacing=0 cellpadding=12 border=0 width=100% layout=fixed>");
                            			out.println("<tr><th>ID</th><th>Name</th><th>DOB</th><th>City</th><th>Mobile</th><th>Email</th></tr>");
                            			if(rs.next()){
                            		...
                            		out.println("</center>");
                            			...
                            			String q3="select * from student_reg sr,branch_reg br where sr.Branch_id="+bid+" and br.course_id="+cid+" and br.branch_id=sr.Branch_id";
                            			ResultSet rs=DAO.displayRecord(q3);
                            			out.println("<center>");
                            			out.println("<table cellspacing=0 cellpadding=12 border=0 width=100% layout=fixed>");
                            			out.println("<tr><th>ID</th><th>Name</th><th>DOB</th><th>City</th><th>Mobile</th><th>Email</th></tr>");
                            			if(rs.next()){
...
<% try{
	...
	if(cid.equals("0") && bid.equals("0")){
		...
		if(rs.next()){
			do{
				out.println("<tr><td>"+rs.getString(1)+"</td><th>"+rs.getString(2)+"</th><th>"+rs.getString(3)+"</th><th>"+rs.getString(5)+"</th><th>"+rs.getString(8)+"</th><th>"+rs.getString(9)+"</th></tr>");
			}while(rs.next());
		}
		out.println("</table>");
		out.println("</center>");
